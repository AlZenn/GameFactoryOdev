...
public class PlayerManager : MonoBehaviour
{
    ...
    [SerializeField] private float yenisp, yenispyol;
    ...
    void Update()
    {
        if (gameState)
        {
            ...
            { 
                ...
                Direction.x = Mathf.Lerp(Direction.x,Input.GetAxis("Mouse X"), Time.deltaTime * runSpeed * yenisp);
           
                Direction = Vector3.ClampMagnitude(Direction,1f);
           
                road.position = new Vector3(0f,0f,Mathf.SmoothStep(road.position.z,-100f,Time.deltaTime * roadSpeed * yenispyol));
